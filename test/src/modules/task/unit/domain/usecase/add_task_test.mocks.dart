...
// in project_list_fliutter/test/src/modules/task/unit/domain/usecase/add_task_test.dart.
...
/// A class which mocks [IPostTaskRepository].
///
/// See the documentation for Mockito's code generation for more information.
class MockIPostTaskRepository extends _i1.Mock
    implements _i2.IPostTaskRepository {
  MockIPostTaskRepository() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.Future<(bool?, _i4.CreateTaskError?)> addTask(
    _i5.Task? task,
    String? userId,
  ) =>
      (super.noSuchMethod(
